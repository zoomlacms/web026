...
- [Zoomla!逐浪CMS卓越出品](#zoomla逐浪cms卓越出品)
  - [逐浪官方开源精品全站项目026：蔬香美园便捷的一键下单线上买菜微信公众号平台](#逐浪官方开源精品全站项目026：蔬香美园便捷的一键下单线上买菜微信公众号平台)
  - [本项目介绍](#本项目介绍)
- [开放性说明](#开放性说明)
  - [使用说明](#使用说明)
- [接口文档](#接口文档)
...
## 逐浪官方开源精品全站项目026：蔬香美园便捷的一键下单线上买菜微信公众号平台
...
这是一个-便捷的线上买菜平台，对接微信公众号，可直接在线下单，支持都店铺发布商品，移动优先，全面支持响应式，其特征包括：
- 服务端基于Zoomla!逐浪CMS开发
- 前端web呈现基于Boostrap 
- 支持chrome和现代化浏览器，兼容IE11与EDGE浏览器
- 对接微信公众号，支持多店铺商品发布
- 后台对接物流信息查询
- 可多店铺下下单购买、打印订单、后台管理配送；
- 对接微信支付，购物可积分等
