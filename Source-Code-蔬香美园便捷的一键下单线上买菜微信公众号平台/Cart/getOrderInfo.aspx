...
<title>订单结算</title>
<style type="text/css">
.arsItem {color:#999;border-color:#ddd;margin-bottom:5px;}
.arsItem:hover { color:#ddd; border-color:#ddd; background:none;}
.arsItem.checked{border:1px solid rgb(70, 184, 218);color:rgb(70, 184, 218); background:none;}
.arsItem input[name=ars_chk]{display:none;}
.arsItem .arsInfo_wrap .input-group{margin-bottom:3px;}
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="row gray_border">
        ...
        <div class="bordered">
            <label class="btn btn-default btn-sm arsItem">
                <i class="fa fa-subway"></i> 用户自提取商品
                <input type="radio" value="self" name="ars_chk"/>
            </label>
            <div class="input-group arsInfo_wrap" style="width:500px;display:none;">
        ...
        <div class="bordered" runat="server" visible="false" id="wx_address">
            ...
            <div class="arsInfo_wrap" style="display: none;">
                <table class="table table-bordered table-striped">
                    <tr><td style="width:100px;">收货人</td><td><input type="text" class="form-control" id="wxad_name" name="wxad_name" /></td></tr>
