...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-bordered">
        <tr>
            <td>
                <div class="col-sm-4 margin_t5 padding0" hidden><select id="province_dp" name="province_dp" class="form-control"></select></div>
                <div class="col-sm-4 margin_t5 padding0"><select id="city_dp" class="form-control"></select></div>
                <div class="col-sm-4 margin_t5 padding0"><select id="county_dp" class="form-control"></select></div>
        ...
        <tr hidden>
            <td>
                <asp:TextBox runat="server" class="form-control num" ID="ZipCode_T" MaxLength="6" placeholder="邮编" value="330000" /></td>
        </tr>
        <tr>
            <td>
        ...
        <tr class="hidden-xs" hidden>
            <td>
                <asp:TextBox runat="server" Style="width: 80px;" class="form-control pull-left num" ID="Area_T" placeholder="区号" MaxLength="4" value="0791" />
                <asp:TextBox runat="server" Style="width: 210px; margin-left: 10px;" class="form-control pull-left num" ID="Phone_T" placeholder="号码" MaxLength="8" value="00000000" /></td>
        </tr>
        ...
        <tr>
            <td class="text-center">
                <asp:Button runat="server" ID="SaveBtn" Text="保存信息" OnClientClick="return CheckForm()" OnClick="SaveBtn_Click" CssClass="btn btn-primary" />
            </td>
        </tr>
    </table>
</asp:Content>
