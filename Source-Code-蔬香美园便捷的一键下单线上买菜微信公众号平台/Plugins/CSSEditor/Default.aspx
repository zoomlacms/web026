    ...
    <div id="app">
     ...
     <%--        
            ...
            <div class="tab-pane" id="custom">
                <div>
                    <button type="button" class="btn btn-info" v-on:click="custom.add();"><i class="fa fa-plus"></i> 新增一行</button>
                </div>
                <div id="custom_body">
                    <div class="item input-group" v-for="item in custom.value">
                        <input type="text" class="form-control" v-model="item.css"/>
                        <span class="input-group-append">
                            <button type="button" class="btn btn-danger" v-on:click="custom.del(item);"><i class="fa fa-trash"></i></button>
                        </span>
                    </div>
                </div>
