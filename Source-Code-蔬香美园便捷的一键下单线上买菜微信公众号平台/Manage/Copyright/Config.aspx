...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="", text="版权配置 [<i class='fa  fa-check-circle-o'></i>配置信息验证成功，请登陆管理版权收入][<a href='/admin//Config/Third/AddPlatInfo.aspx?action=copyright&amp;id="+platMod.ID+"'>重新配置</a>]",addon="" }}
		)
    %>
