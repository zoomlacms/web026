...
<ul>
	<li><a href="../Config/SiteInfo.aspx"><i class="fa fa-cogs"></i></a><a href="../Config/SiteInfo.aspx" target="_self">快速配置</a></li>
	<li><a href="../Content/Model/ModelManage.aspx?ModelType=1"><i class="fa fa-puzzle-piece"></i></a><a href="../Content/ModelManage.aspx?ModelType=1" target="_self">模型构造</a></li>
	<li><a href="../Content/Node/NodeManage.aspx"><i class="fa fa-university"></i></a><a href="../Content/NodeManage.aspx" target="_self">节点规划</a></li>
	<li><a href="../Template/LabelManage.aspx"><i class="fa fa-tags"></i></a><a href="../Template/LabelManage.aspx" target="_self">标签调用</a></li>
	<li><a href="../Template/TemplateSet.aspx"><i class="fa fa-cubes"></i></a><a href="../Template/TemplateSet.aspx" target="_self">模板列表</a></li>
	<li><a href="../Content/ContentManage.aspx"><i class="fa fa-file-text-o"></i></a><a href="../Content/ContentManage.aspx" target="_self"><%=Resources.L.内容管理 %></a></li>
	<li><a href="../WorkFlow/OAConfig.aspx"><i class="fa fa-delicious"></i></a><a href="../WorkFlow/OAConfig.aspx" target="_self">OA办公</a></li>
	<li><a href="../WeiXin/home.aspx"><i class="fa fa-weixin"></i></a><a href="../WeiXin/home.aspx" target="_self">微信开发</a></li>
	<li><a href="../Content/ECharts/AddChart.aspx"><i class="fa fa-database"></i></a><a href="../Content/ECharts/AddChart.aspx" target="_self">数据舆情</a></li>
	<li><a href="../..//AdminMVC/CRM/ClientList"><i class="fa fa-industry"></i></a><a href="../../AdminMVC/CRM/ClientList" target="_self">CRM</a></li>		
	<li><a href="../iServer/BiServer.aspx"><i class="fa fa-coffee"></i></a><a href="../iServer/BiServer.aspx" target="_self">客户服务</a></li>		
</ul>
</div>
</div>
</div>
...
<div class="card">
<div class="card-header">
<i class="fa fa-file-word-o"></i> <%=Resources.L.内容管理 %> <a class="badge badge-secondary pull-right" href="javascript:;" title="<%=Resources.L.内容管理 %>" onclick="ShowMain('NodeTree.ascx','Content/ContentManage.aspx');">More</a></div>
...
<a href="javascript:;" class="btn btn-light btn-sm" onclick="shoptabs('goods');"><i class="fa fa-shopping-bag"></i> 商品</a>
<a href="javascript:;" class="btn btn-light btn-sm" onclick="shoptabs('order');"><i class="fa fa-shopping-cart"></i> 订单</a>
<a href="javascript:;" class="btn btn-light btn-sm" onclick="shoptabs('pay');"><i class="fa fa-dollar"></i> 流水</a>
...
<div class="card">
<div class="card-header">
<i class="fa fa-user"></i> <%=Resources.L.会员管理 %><a class="badge badge-secondary pull-right" href="javascript:;" title="<%=Resources.L.会员管理 %>" onclick="ShowMain('UserGuide.ascx','User/UserManage.aspx');">More</a>
</div>
<div class="card-body">
...
<div class="col-sm-4 sys_overhid">
<div class="card">
<div class="card-header"><i class="fa fa-globe"></i> <%=Resources.L.浏览信息 %>
</div>
...
<div class="card">
<div class="card-header  pb-1">
<a href="javascript:;" class="btn btn-light btn-sm" onclick="showPanel('sche');"><i class="fa fa-clock-o"></i> 任务计划</a>
<a href="javascript:;" class="btn btn-light btn-sm" onclick="showPanel('note');"><i class="fa fa-book"></i> <%=Resources.L.备忘录 %></a>
</div>
