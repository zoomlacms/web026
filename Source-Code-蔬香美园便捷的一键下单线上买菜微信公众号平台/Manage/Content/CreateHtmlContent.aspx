...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
  ...
  <div class="Creat_tips list_choice">
    <div class="alert alert-warning alert-dismissible fade show">
      ...
      <p class="pl-5"> <strong> <span class='fa fa-warning text-danger'></span>
      ...
      <div class="tab-pane active row sysRow" id="Tab1">
        <table class="table table-bordered table-hover sys_table">
          ...
          <tr>
            ...
            <td><asp:Button ID="btnNewsContent" runat="server" Text="<%$Resources:L,发布所有内容 %>" CssClass="btn btn-info" OnClick="btnNewsContent_Click" OnClientClick="return confirm('确定要将所有内容页生成Html吗?');"/></td>
          </tr>
          <tr>
            <td colspan="2">
