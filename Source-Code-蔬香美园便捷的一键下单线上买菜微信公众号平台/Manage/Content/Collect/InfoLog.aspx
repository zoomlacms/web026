...
%>
    ...
    <div class="list_choice d-flex flex-row">
        <div class="d-flex flex-row">
            <asp:TextBox runat="server"  ID="BeginTime_T" onclick="WdatePicker()"  CssClass="form-control w12rem_lg" placeholder="开始时间"></asp:TextBox>
            <span>-</span>
    <asp:TextBox runat="server" ID="EndTime_T" onclick="WdatePicker()"  CssClass=" form-control w12rem_lg" placeholder="结束时间"></asp:TextBox>
        </div>
        ...
        <div class="input-group max20rem">
            ...
            <span class="input-group-btn">
                <asp:LinkButton runat="server" CssClass="btn btn-outline-secondary" OnClick="souchok_Click" ID="souchok_B"><span class="fa fa-search"></span></asp:LinkButton>
            </span>
        </div>
    </div>
