            ...
            <td>
				...
				<div class="input-group-prepend">
				  ...
				  <div class="input-group-append">
					<asp:LinkButton ID="LinkButton1" runat="server" OnClick="Button4_Click" CssClass="btn btn-outline-secondary"><span class="fa fa-search"></span></asp:LinkButton>
				  </div>
				</div>
            </td>
        </tr>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="<%$Resources:L,生成操作 %>">
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="LinkButton2" runat="server" CommandName="MakeHtml" CommandArgument='<%# Eval("GeneralID") %>' CausesValidation="false"><i class="fa fa-spinner" title="<%=Resources.L.生成 %>"></i><%=Resources.L.生成文件 %></asp:LinkButton>
                    <a href="<%#(geturl(Eval("GeneralID","{0}"))=="")?"javascript:void(0);":geturl(Eval("GeneralID","{0}"))%>" ><i class="fa fa-eye" title="预览" ></i><%=Resources.L.查看文件 %></a>
				<a href="ListHtmlContent.aspx?GeneralID=<%# Eval("GeneralID") %>"><i class="fa fa-trash-o" title="<%=Resources.L.删除 %>"></i><%=Resources.L.删除 %></a>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
        </Columns>
