<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchNode.aspx.cs" Inherits="ZoomLaCMS.Manage.I.ASCX.BatchNode" MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="head">
	...
	<%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="", text="节点批量设置",addon="" }},
		Call.GetHelp(16)
		)
    %>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered sys_table">
        <tr class="sys_move_list text-center">
            <td><span class="text-success" id="curNode_span">当前节点:尚未选定</span></td>
            <td>批量设置节点</td>
        </tr>
        <tr class="sys_move_list">
            <td valign="top" align="center" class="w12rem_lg">
                <table>
                    <tr>
                        <td align="left">
                    ...
                    <tr>
						...
						<div class="d-flex justify-content-start">
                            <input id="BtnSelectAll" onclick="SelectAll()" type="button" class="btn btn-outline-info mr-1" value="选定所有节点" />
                            <input id="BtnCancelAll" onclick="UnSelectAll()" type="button" class="btn btn-outline-info" value="取消所有节点" /></div>
                        </td>
                    </tr>
                </table>
            </td>
            <td valign="top">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active show" href="#Tabs0" data-toggle="tab">栏目选项</a></li>
                    <li class="nav-item"><a class="nav-link" href="#Tabs1" data-toggle="tab">模板选项</a></li>
                    <li class="nav-item"><a class="nav-link" href="#Tabs2" data-toggle="tab">收费设置</a></li>
                    <li class="nav-item"><a class="nav-link" href="#Tabs3" data-toggle="tab">生成选项</a></li>
                    <li class="nav-item"><a class="nav-link" href="#Tabs4" data-toggle="tab">浏览权限</a></li>
                    <li class="nav-item"><a class="nav-link" href="#Tabs5" data-toggle="tab">操作权限</a></li>
                </ul>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right"><strong>安全防护</strong></th>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right"><strong>简洁模式</strong></th>
                            ...
                            <tbody>
                                <tr >
                                    ...
                                    <th class="w12rem_lg">
										...
										<small class="text-muted">注：会员在此栏目下阅读内容时，该内容默认的收费点券数</small>
                                    </th>
                                    <td>
										<div class="input-group">
										<asp:TextBox ID="TxtConsumePoint" class="form-control pull-left max20rem"  runat="server" Columns="5">0</asp:TextBox>
                                ...
                                <tr >
                                    ...
                                    <th>
                                        ...
                                        <small class="text-muted">注：会员在此栏目下阅读内容时，该内容的重复收费方式</small>
                                    </th>
                                    <td>
                                ...
                                <tr >
                                    ...
                                    <th>
										...
										<small class="text-muted">注：会员在此栏目下添加内容时，该内容默认的分成比例</small>
                                    </th>
                                    <td>
										<div class="input-group">
										<asp:TextBox ID="TxtShares" class="form-control pull-left max20rem"  runat="server" Columns="5">0</asp:TextBox>
										  <div class="input-group-append">
                                ...
                                <tr >
                                    ...
                                    <th>
										...
										<small class="text-muted">注：会员在此栏目下发布内容时，每发布一篇内容收费</small>
                                    </th>
                                    <td>
										<div class="input-group mb-2">
										<asp:TextBox ID="TxtAddMoney" class="form-control pull-left max20rem"  runat="server" Columns="8">0</asp:TextBox>
										  <div class="input-group-append">
											<span class="input-group-text">元</span>
										  </div>
										</div>
										<div class="input-group mb-2">
										<asp:TextBox ID="TxtAddPoint" class="form-control pull-left max20rem" runat="server" Columns="8">0</asp:TextBox>
										  <div class="input-group-append">
											<span class="input-group-text">点券</span>
										  </div>
										</div>
										<div class="input-group ">
										<asp:TextBox ID="txtAddExp" class="form-control pull-left max20rem"  runat="server" Columns="8">0</asp:TextBox>
										  <div class="input-group-append">
                                ...
                                <tr >
                                    ...
                                    <th>
										...
										<small class="text-muted">注：会员在此栏目下载内容时，每下载一次所需费用</small>
                                    </th>
                                    <td>
										<div class="input-group ">
										<asp:TextBox ID="txtDeducExp" class="form-control pull-left max20rem" runat="server" Columns="8">0</asp:TextBox>
										  <div class="input-group-append">
											<span class="input-group-text">积分</span>
										  </div>
										</div>
                            ...
                            <tbody>
                                <tr >
                                    ...
                                    <th class="w12rem_lg">
										...
										<small class="text-muted">注： 栏目权限为继承关系。例如：当父栏目设为“认证栏目”时，子栏目的权限设置将继承父栏目设置，即使子栏目设为“开放栏目”也无效。相反，如果父栏目设为“开放栏目”，子栏目可以设为“半开放栏目”或“认证栏目”。</small>
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <small class="text-muted">注： 如果栏目是“半开放栏目”或“认证栏目”，请在此设置允许浏览此栏目的会员组。</small>
                                    </th>
                                    <td>
                                ...
                                <tr >
                                    <th>
										...
										<small class="text-muted">注： 请在此设置允许在此栏目发表信息的会员组。游客没有发表信息权限。</small>
                                    </th>
                                    <td>
                            ...
                            <tbody>
                                <tr >
                                    ...
                                    <th style="text-align: right;width:200px;">
										...
										<small class="text-muted">(注： 请勾上左边单选框,确认更改)。</small>
                                    </th>
                                    <td>
                                        <ZL:ExGridView ID="Egv" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="RoleID" Width="100%">
                                            <Columns>
                                              <asp:TemplateField HeaderText="角色名">
                                                  ...
                                                  <ItemTemplate>
                                                      <label><%#Eval("RoleName") %>
                                                      <input type="checkbox" onclick="CheckAll();" /></label>
                                                  </ItemTemplate>
                                              </asp:TemplateField>
                                                <asp:TemplateField HeaderText="查看">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('look');" />查看</label>
                                                    </HeaderTemplate>
                                                    <HeaderStyle  />
                                                    <ItemTemplate>
                                                        <asp:CheckBox data-auth="look" ID="chkSel1" runat="server" />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="录入">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('addto');" />录入</label>
                                                    </HeaderTemplate>
                                                    <HeaderStyle  />
                                                    <ItemTemplate>
                                                        <asp:CheckBox data-auth="addto" ID="chkSel2" runat="server" />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="审核">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('state');" />审核</label>
                                                    </HeaderTemplate>
                                                    <HeaderStyle  />
                                                    <ItemTemplate>
                                                        <asp:CheckBox data-auth="state" ID="chkSel3" runat="server" />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="信息管理">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('xxgl');" />信息管理</label>
                                                    </HeaderTemplate>
                                                    <HeaderStyle />
                                                    <ItemTemplate>
                                                        <asp:CheckBox data-auth="xxgl" ID="chkSel4" runat="server" />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="当前栏目管理">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('col');" />当前栏目管理</label>
                                                    </HeaderTemplate>
                                                    <HeaderStyle />
                                                    <ItemTemplate>
                                                        <asp:CheckBox data-auth="col" ID="chkSel5" runat="server" />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="评论管理">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('plgl');" />评论管理</label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:CheckBox data-auth="plgl" ID="chkSel6" runat="server" />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                            </Columns>
                                        ...
                                        <ZL:ExGridView ID="GridView1" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="GroupID" Width="100%">
                                            <Columns>
                                                <asp:TemplateField HeaderText="会员组">
                                                    <HeaderTemplate>
                                                        <label><input type="checkbox" onclick="ChkAll('group');" />会员组</label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <label><input type="checkbox" onclick="CheckAll()" /></label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="查看">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:CheckBox ID="chkSel1" data-auth="look2" runat="server" Checked='<%#GetGrouplook(Eval("GroupID","{0}")) %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="下载">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:CheckBox ID="chkSel11" data-auth="down" runat="server" Checked='<%#GetGroupDown(Eval("GroupID","{0}")) %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="引用">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('yy');" />引用</label>
                                                    </HeaderTemplate>
                                                    <HeaderStyle />
                                                    <ItemTemplate>
                                                        <asp:HiddenField ID="HiddenGroupID2" runat="server" Value='<%#GetGroupquote(Eval("GroupID","{0}")) %>' />
                                                        <asp:CheckBox ID="chkSel12" data-auth="yy" runat="server" Checked='<%#GetGroupquote(Eval("GroupID","{0}")) %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="录入">
                                                    ...
                                                    <HeaderStyle Width="7%" />
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkSel2" data-auth="addto2" runat="server" Checked='<%#GetGroupAddto(Eval("GroupID","{0}")) %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="修改">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('update');" />修改</label>
                                                    </HeaderTemplate>
                                                    <HeaderStyle  />
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkSel3" data-auth="update" runat="server" Checked='<%#GetGroupModify(Eval("GroupID","{0}")) %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="删除">
                                                    ...
                                                    <HeaderStyle  />
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkSel4" data-auth="del" runat="server" Checked='<%#GetGroupModify(Eval("GroupID","{0}")) %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="仅当前节点">
                                                    ...
                                                    <HeaderStyle  />
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkSel5" data-auth="col2" runat="server" Checked='<%#GetGroupColumns(Eval("GroupID","{0}")) %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="评论管理">
                                                    <HeaderTemplate>
                                                      <label><input type="checkbox" onclick="ColChk('plgl2');" />评论管理</label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkSel6" data-auth="plgl2" runat="server" Checked='<%#GetGroupComments(Eval("GroupID","{0}")) %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                            </Columns>
        ...
        <tr class="text-center">
            <td colspan="2">
                <asp:Button ID="EBtnBacthSet" class="btn btn-outline-info" Text="执行批处理" OnClick="EBtnBacthSet_Click" runat="server" />
                <a href="NodeManage.aspx" class="btn btn-outline-info">取消</a>
            </td>
        </tr>
    </table>
	</div>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        function CheckAll()
        {
            ...
            $obj.parent().parent().parent().find("input:checkbox").each(function(){this.checked=$obj.get(0).checked});
        }
        function ChkAll(type) {
            obj = event.srcElement;
            if (type == 'admin') { $("#Egv input[type=checkbox]").each(function () { this.checked = obj.checked; }); }
            if (type == 'group') { $("#GridView1 input[type=checkbox]").each(function () { this.checked = obj.checked; }); }
        }
