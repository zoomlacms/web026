...
<%=Call.SetBread(new Bread[] {
	...
	Call.GetHelp(103)+"<div class='pull-right mr-2'><a href='" + Request.RawUrl + "' title='刷新'><i class='fa fa-refresh'></i></a></div>"
	)
%>
...
<div class="tab-content col-12 table_box">
    <div class="co-1 tab-pane active" id="Tabs0">
        <table class="table table-striped table-bordered table-hover sys_table">
            ...
            <tbody>
                <tr>
                    <td class="w12rem_lg"><strong>所属栏目：</strong></td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span id="TxtNodeName_sp" class="text-danger">*</span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span id="TxtNodeDir_sp" class="text-danger">*</span>
                        <small class="text-muted">注意：目录名只能是字母、数字、下划线组成，首字符不能是数字
            ...
            <tbody>
                <tr>
                    <td class="w12rem_lg">
						...
						<small class="text-muted">注：会员在此栏目下阅读内容时，该内容默认的收费积分数</small>
                    </td>
                    <td>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <input runat="server" type="button" onclick="createHtml();" id="Release_Btn"  visible="false" class="btn btn-info ml-2" value="发布该节点" />
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <tbody>
                <tr>
                    <td class="w12rem_lg">
                        ...
                        <small class="text-muted">栏目权限为继承关系。例如：当父栏目设为“认证栏目”时，子栏目的权限设置将继承父栏目设置，即使子栏目设为“开放栏目”也无效。相反，如果父栏目设为“开放栏目”，子栏目可以设为“半开放栏目”或“认证栏目”。</small>
                ...
                <tr>
                    <td>
						...
						<small class="text-muted">请在此设置允许在此栏目发表信息的会员组。 游客没有发表信息权限。</small>
                    </td>
                    <td>
