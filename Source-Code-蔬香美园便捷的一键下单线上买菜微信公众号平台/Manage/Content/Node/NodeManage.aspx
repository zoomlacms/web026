...
<%=Call.SetBread(new Bread[] {
    ...
    new Bread(){
        url="NodeManage.aspx",
        text="节点管理",
        addon="<a href='NodeManage.aspx?action=showall'>[展开所有节点]</a>"
        +"<a href=\'NodeManage.aspx\' >[收缩所有节点]</a>"
        +"<a href=\'javascript:void(0)\' onclick=\'emptynode()\'>[删除所有节点]</a>"
        +"<a href=\"" + customPath2 + "Config/EmptyData.aspx\">[初始化全站数据]</a>"
    }},
    Call.GetHelp(15)+"<div class='pull-right' style='margin-right:10px;'><a href='NodeRecycle.aspx' style='margin-left:15px;'>[节点回收站]</a>"
    )
%>
