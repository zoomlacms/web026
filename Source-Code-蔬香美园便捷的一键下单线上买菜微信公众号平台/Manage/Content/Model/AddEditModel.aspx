		...
		<td>
            <div class="input-group">
                <span class="input-group-prepend">
                    <asp:Label class="input-group-text" ID="LblTablePrefix" runat="server" />
                </span>
   ...
   <tr>
	...
	<tr>
		...
		<td colspan="2" class="text-left panel_footers">
			<asp:Button ID="EBtnSubmit"  Text="保存信息" OnClientClick="return CheckData();" class="btn btn-outline-info submit-loading"  OnClick="EBtnSubmit_Click" runat="server" />
			&nbsp;&nbsp;
