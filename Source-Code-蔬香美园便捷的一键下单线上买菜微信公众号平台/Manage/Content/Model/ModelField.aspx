...
<div class="panel panel-default container-fluid pr-0">
    <div class="panel-body row sysRow list_choice table-responsive">
            ...
            <ZL:Repeater ID="RPT" runat="server" OnItemCommand="rptModelField_ItemCommand">
                <ItemTemplate>
                    <tr data-id="<%#Eval("FieldID") %>" ondblclick="GetToUrl(' <%# Eval("FieldID") %>','<%# Eval("ModelID") %>');">
                        ...
                        <td class="text-center">
                            <a href="AddModelField.aspx?FieldID=<%# Eval("FieldID") %>&ModelID=<%# Eval("ModelID") %>&ModelType=<%:ModelType %>"><i class="fa fa-pencil" title="修改"></i></a>
