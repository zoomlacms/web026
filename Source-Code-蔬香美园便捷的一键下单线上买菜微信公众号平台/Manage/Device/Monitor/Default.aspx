<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Manage.Device.Monitor.Default" MasterPageFile="~/Manage/I/Index.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="MonitorAdd.aspx", text="添加设备",addon="" }}
		)
    %>
