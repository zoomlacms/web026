<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkCount.aspx.cs" Inherits="ZoomLaCMS.Manage.Workload.WorkCount"MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
		...
		Call.GetHelp(52)+"<div class='pull-right down_ico' onclick='downtable();' style='cursor: pointer' title='导出数据表'> <span class='fa fa-download'></span> </div>"
		)
    %>
	...
	<div class="row">
        ...
        <div id="countlist_div" class="col-12 col-sm-10 table-responsive">
