<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FuncList.aspx.cs" Inherits="ZoomLaCMS.Manage.Workload.FuncList" MasterPageFile="/Manage/I/Index.Master" %>
...
<div class="row " id="card_1" data-children="item">
	...
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_1_1" aria-expanded="true" aria-controls="card_1_1"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
		...
		<div class="card-body" id="card_1_1" class="collapse" role="tabpanel">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_2_2" aria-expanded="true" aria-controls="card_2_2"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_2_2" class="card-body">
			<div class="list-group">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_3_3" aria-expanded="true" aria-controls="card_3_3"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_3_3" class="card-body">
			<div class="list-group">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_4_4" aria-expanded="true" aria-controls="card_4_4"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_4_4" class="card-body">
			<div class="list-group">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_5_5" aria-expanded="true" aria-controls="card_5_5"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_5_5" class="card-body">
			<div class="list-group">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_6_6" aria-expanded="true" aria-controls="card_6_6"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_6_6" class="card-body">
			<div class="list-group">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_7_7" aria-expanded="true" aria-controls="card_7_7"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_7_7" class="card-body">
			<div class="list-group">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_8_8" aria-expanded="true" aria-controls="card_8_8"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_8_8" class="card-body">
			<div class="list-group">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_9_9" aria-expanded="true" aria-controls="card_9_9"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_9_9" class="card-body">
			<div class="list-group">
...
<div class="col-md-6  col-12 p-2">
	<div class="card">
		<div class="card-header">
			<div class="pull-right">
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-collapse" data-toggle="collapse" data-parent="#card_1" href="#card_10_10" aria-expanded="true" aria-controls="card_10_10"><i class="fa fa-caret-up"></i></button>
				</div>
				<div class="btn-group">
					<button type="button" class="btn btn-default panel-maxible"><i class="fa fa-expand" aria-hidden="true"></i></button>
				</div>
		...
		<div id="card_10_10" class="card-body">
			<div class="list-group">
