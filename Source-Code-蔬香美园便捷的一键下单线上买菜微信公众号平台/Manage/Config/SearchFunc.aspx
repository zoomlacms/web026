...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script runat="server">
        ...
        public string ShowLinkType()
        {
            ...
            if (url.StartsWith("http") || url.StartsWith("https")) { return "<i class='fa fa-chain' style='color:#FF7A00;'></i>"; }
            switch (DataConverter.CLng(Eval("Type")))
            {
                case 0://站内链接  
                    result = "<i class='fa fa-folder-open' style='color:#FF7A00;'></i>";
                    break;
                case 1://用户中心
                    result = "<i class='fa fa-list-alt' style='color:#FF7A00;'></i>";
                    break;
                case 2://站外链接
                    result = "<i class='fa fa-folder-open' style='color:#FF7A00;'></i>";
                    break;
        ...
        public string ShowAttribute()
        {
            ...
            {
                result += "<i class='fa fa-mobile' title='支持移动' style='font-size:22px;color:#FF7A00;'/> ";
            }

            string linkUrl = Eval("FileUrl", "").Replace("/Manage/",customPath2).ToLower();
            if (linkUrl.Equals(startUrl))
            {
                result += "<i class='fa fa-home' title='启动页' style='font-size:20px; color:#FF7A00;'/> ";
            }
            return result;
        }
    </script>
