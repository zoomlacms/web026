<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BackupRestore.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.BackupRestore" MasterPageFile="~/Manage/I/Index.master"%>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div runat="server" id="maindiv" visible="false">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link active" href="#tab0" data-toggle="tab"><i class="fa fa-database"></i> 数据备份</a></li>
            <li class="nav-item"><a class="nav-link" href="#tab1" data-toggle="tab"><i class="fa fa-folder-open"></i> 文件备份</a></li>
        </ul>
        <table id="tab0" class="table table-striped table-bordered table-hover tabs sys_table">
            <tr><td colspan="2" class="tdtitle">数据库备份</td></tr>
            <tr><th class="w12rem_lg">主数据库名</th><td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span id="backup_sp" runat="server" class="padding10"> 
                        <asp:CheckBox ID="chBackup" runat="server" class="chkwrap"/><label for="chBackup" style="font-weight:normal">备份在根目录(默认为temp目录)。</label> </span>
                </td>
            </tr>
            <tr>
                <th>管理员操作</th>
