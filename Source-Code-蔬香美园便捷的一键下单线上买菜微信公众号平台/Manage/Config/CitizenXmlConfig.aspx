    ...
    <ZL:ExGridView ID="EGV" RowStyle-HorizontalAlign="Center" runat="server" DataKeyNames="FileName" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:TemplateField HeaderText="选择">
                ...
                <ItemStyle CssClass="w12rem_lg" HorizontalAlign="Left" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Edit1" CommandArgument='<%# Eval("FileName") %>' ><i class="fa fa-pencil" title="修改"></i>修改</asp:LinkButton> 
                    <asp:LinkButton ID="LinkButton3" runat="server" CommandName="DicList" CommandArgument='<%# Eval("FileName") %>' ><i class="fa fa-list-alt" title="列表"></i>下级选项列表</asp:LinkButton>
                </ItemTemplate>
