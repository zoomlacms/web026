...
<div class="tab-content col-12 table_box">
        <div class="tab-pane  col-12 table_box active" id="Tabs0">
            <table class="table table-striped table-bordered sys_table">
                <tbody>
                    ...
                    <tr><th><strong>注册可选会员组</strong></td><th>
	...
	<div class="alert alert-light">
        <asp:Button runat="server" Text="保存设置" OnClick="Save_Click" class="btn btn-outline-info" /></div>
</div>
</div>
</asp:Content>
