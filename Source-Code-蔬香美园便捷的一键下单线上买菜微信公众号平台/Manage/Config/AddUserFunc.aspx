...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered table-hover sys_table">
<tr>
...
<tr>
	<td class="text-center" colspan="2">
		<button type="button" id="Edit_Btn" runat="server" class="btn btn-outline-info" onclick="CheckSubmit()">添加导航</button>
