<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RouteConfig.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.RouteConfig" MasterPageFile="~/Manage/I/Index.master" %>
...
<%=Call.SetBread(new Bread[] {
	...
	new Bread("","网站配置"),
	new Bread() {url="", text="网站路由器<a href='AddNodeRoute.aspx'>[添加路由]</a>",addon="" }}
	)
%>

<div class="bs-example bs-example-standalone list_choice" data-example-id="dismissible-alert-js">
<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <strong>欢迎使用站点路由器，使您的目录绑定域名!</strong> 
  <span class="ml-2">在使用前您需要对您的域名进行泛解析或在本地设置Host文件进行测，关于这一教程您可以访问逐浪官网搜索与“站群”相关的内容。</span>
  
</div>
<ul class="nav nav-tabs">
    <li class="nav-item"><a class="nav-link active" href="#cutstomdiv" data-toggle="tab">节点路由</a></li>
    <li class="nav-item"><a class="nav-link" href="#systemdiv" data-toggle="tab">系统路由</a></li>
</ul>
<div class="tab-content">
    <div id="cutstomdiv" class="tab-pane active">
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="指向" DataField="Url" />
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a class="option_style" href="AddNodeRoute.aspx?id=<%#Eval("ID") %>"><i class="fa fa-pencil" title="修改"></i></a>
    ...
    <div id="systemdiv" class="tab-pane container-fluid pr-0">
	<div class="row sysRow">
        ...
        <tr>
            ...
            <td><a href="/Guest/Bar/" target="_blank" title="浏览页面">/Bar/</a></td>
            <td><a class="disabled">修改</a> <a class="disabled">删除</a></td>
        </tr>
        <tr>
            <td>百科</td>
            ...
            <td><a href="/Baike/" target="_blank" title="浏览页面">/Baike/</a></td>
            <td><a class="disabled">修改</a> <a class="disabled">删除</a></td>
        </tr>
        <tr>
            <td>问答</td>
            ...
            <td><a href="/Ask/" target="_blank" title="浏览页面">/Ask/</a></td>
            <td><a class="disabled">修改</a> <a class="disabled">删除</a></td>
        </tr>
        <tr>
            <td>留言</td>
        ...
        <tr>
            ...
            <td><a href="/Office/" target="_blank" title="浏览页面">/Office/</a></td>
            <td><a class="disabled">修改</a> <a class="disabled">删除</a></td>
        </tr>
    </table>
	</div>
...
<%--<div class="alert alert-info">添加二级域名后,如未生效,请重启服务器(静态变量不在不同域名间共享)</div>--%>
    <asp:Button runat="server" CssClass="btn btn-outline-danger" ID="BatDel_Btn" Text="批量删除" OnClick="BatDel_Btn_Click" OnClientClick="return confirm('确定要删除吗?');" />
	</div>
</asp:Content>
