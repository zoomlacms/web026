<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmptyData.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.EmptyData" MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="EmptyData.aspx", text="清空测试数据",addon="" }},
		Call.GetHelp(71)
		)
    %>
    ...
    <table class="table table-striped table-bordered table-hover sys_table">
        <tr><td colspan="2">选择要清除测试数据的数据库类别</td></tr>
        <tr>
            <th class="w12rem_lg"><label>内容 <input type="checkbox" class="clearchk" checked="checked" /></label></th>
            <td>
        ...
        <tr>
            <th><label>商城 <input type="checkbox" class="clearchk" checked="checked" /></label></th>
            <td>
        ...
        <tr>
            <th><label>社区 <input type="checkbox" class="clearchk"/></label></th>
            <td>
        ...
        <tr>
            <th><label>能力 <input type="checkbox" class="clearchk"/></label></th>
            <td>
        ...
        <tr>
            <th><label>用户 <input type="checkbox" class="clearchk"/></label></th>
            <td>
                <label><input type="checkbox" name="tbname_chk"  value="ZL_User"/>ZL_User&nbsp;&nbsp;[所有用户数据(不涉及管理员信息)]</label><br />
            </td>
        </tr>
        <tr><td></td><td>
            <input type="button" id="EmptyData" value="一键清空测试数据" class="btn btn-outline-info" onclick="$('#confirm').show();"/></td>
        </tr>
    </table>
