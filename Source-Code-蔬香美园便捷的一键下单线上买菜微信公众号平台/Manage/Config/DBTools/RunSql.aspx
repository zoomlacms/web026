<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RunSql.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.RunSql" MasterPageFile="~/Manage/I/Index.master" ValidateRequest="false"%>
                ...
                <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                                <asp:LinkButton runat="server"  CommandName="execute" CommandArgument='<%#Eval("Path") %>' OnClientClick="return confirm('确定要执行该脚本吗');"><i class="fa fa-play" title="执行"></i>执行</asp:LinkButton>
                                <asp:LinkButton runat="server"  CommandName="del2" CommandArgument='<%#Eval("Path") %>' OnClientClick="return confirm('确定要删除吗');"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </ZL:ExGridView>
