<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.DBTools.Default" MasterPageFile="~/Manage/I/Index.master" EnableViewState="false" %>
...
<div class="card pull-left col-12 col-sm-3">
    <div class="card-header"><i class="fa fa-table"></i> 数据表</div>
    <div class="card-body p-1">
        <div class="input-group" style="border-bottom:1px solid #ddd;padding-bottom:5px;">
            ...
            <span class="input-group-btn"><button type="button" class="btn btn-outline-secondary" onclick="dbtool.table_filter();"><i class="fa fa-search"></i></button></span>
        </div>
...
<div class="card pull-right col-12 col-sm-9" id="data_panel">
