<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewList.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.ViewList" MasterPageFile="~/Manage/I/Index.master"%> 
...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="ViewInfo.aspx?ViewName=<%#Eval("ViewName") %>"><i class="fa fa-eye" title="查看"></i></a>
                    <asp:LinkButton runat="server" CommandName="del2" CommandArgument='<%#Eval("ViewName") %>' OnClientClick="return confirm('你确认要删除该视图吗？')"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
