...
<div id="template" runat="server" class="template">
    <ol class="breadcrumb navbar-fixed-top">
        ...
        <div id="help" class="pull-right text-center pr-2"><a href="javascript:;" id="sel_btn" class="help_btn"><i class="fa fa-search"></i></a></div>
        <div id="sel_box" runat="server">
            ...
            <div class="input-group pull-left max20rem">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton runat="server" CssClass="btn btn-outline-secondary" ID="souchok" OnClick="souchok_Click"><span class="fa fa-search"></span></asp:LinkButton>
                </span>
            </div>
        </div>
    </ol>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:LinkButton ID="del_btn" runat="server" CommandName="del" CommandArgument='<%# Eval("ID") %>' OnClientClick="return confirm('确定删除这条浏览记录吗?')"><i class="fa fa-trash-o"></i>删除</asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
