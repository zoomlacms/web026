        ...
        CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="数据为空">
         <Columns>
             ...
             <asp:TemplateField HeaderText="操作">
	            <ItemTemplate> 
                  <a href="AddRes.aspx?id=<%#Eval("ID") %>" title="修改"><span class="fa fa-pencil"></span></a>
	              <asp:LinkButton runat="server"  CommandName="Del" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('你确定要删除吗!');" ToolTip="删除"> <span class="fa fa-trash-o"></span>删除</asp:LinkButton>
	            </ItemTemplate>
             </asp:TemplateField>
         </Columns>
     </ZL:ExGridView>
