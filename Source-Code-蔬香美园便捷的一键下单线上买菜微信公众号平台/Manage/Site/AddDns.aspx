<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDns.aspx.cs" Inherits="ZoomLaCMS.Manage.Site.AddDns"  MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <asp:TextBox runat="server" ID="searchText" placeholder="请输入用户名" CssClass="form-control max20rem"/>
  <span class="input-group-btn">
      <asp:Button runat="server" ID="searchBtn" Text="搜索" OnClick="searchBtn_Click" CssClass="btn btn-outline-secondary"/> 
  </span>
</div>
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                 ...
                 <%--   <tr><td>Mail：</td><td><asp:TextBox runat="server" ID="dom_mailT" class="form-control"/></td></tr>--%>
                    ...
                    <tr><td>操作：</td>
                        <td><asp:Button runat="server" ID="saveBtn" Text="添加" class="btn btn-info" OnClick="saveBtn_Click"  ValidationGroup="add" UseSubmitBehavior="false"/>
                            <input type="button" id="returnBtn" value="返回列表" class="btn btn-outline-info" onclick="location = 'DNSManage.aspx';"/></td></tr>
                </tbody>
            </table>
    ...
    <div class="panel panel-primary" style="float:right;width:68%;" id="subDiv" runat="server" visible="false">
        ...
        <div class="panel-body">
            ...
            <asp:Button runat="server" ID="subSaveBtn" Text="保存修改" OnClick="subSaveBtn_Click" CssClass="btn btn-outline-info" UseSubmitBehavior="false"/>
            <asp:Button runat="server" ID="subDelBtn" Text="批量删除" OnClick="subDelBtn_Click" CssClass="btn btn-outline-danger"
            ...
            <table class="table table-bordered " style="margin-top:10px;">
                ...
                <tr><td>操作:</td><td>  <asp:Button runat="server" ID="addSubBtn" Text="添加" OnClick="addSubBtn_Click" CssClass="btn btn-outline-info" ValidationGroup="subAdd" UseSubmitBehavior="false"/></td></tr>
            </table>
        </div>
    </div>
    </div>
