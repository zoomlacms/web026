<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteConfig.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.SiteConfigPage"  MasterPageFile="~/Manage/I/Index.master"%>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="/{manage}/Site/SiteConfig.aspx", text="全局配置",addon="" }}
		)
    %>
    <div id="site_main" class="list_choice">
        <span runat="server" id="remind"  class="text-danger" />
        <div id="editDiv">
            <ul>
                <li>
                    <input type="button" value="编辑" onclick="dis('tab4');" class="btn btn-info" /></li>
            </ul>
        </div>
        <div id="tab4" style="display: none;">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding5">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active" href="#tabBody0" data-toggle="tab">基本设置</a></li>
                    <li class="nav-item"><a class="nav-link" href="#tabBody1" data-toggle="tab">智能建站</a></li>
                </ul>
...
<div class="clearfix"></div>
    <div id="about" class="site_cont p-4">
