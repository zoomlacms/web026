...
<ol id="BreadNav" class="breadcrumb navbar-fixed-top">
    ...
    <li class="breadcrumb-item"><a href="Pubsinfo.aspx?Pubid=<%=PubID %>">互动模块管理</a></li>
...
<div class="alert alert-light">
    <asp:Button runat="server" ID="BatDel_Btn" class="btn btn-outline-danger" Text="批量删除" OnClick="BatDel_Btn_Click"/>
    <asp:Button runat="server" ID="BatAudit_Btn" class="btn btn-outline-info" Text="批量审核" OnClick="BatAudit_Btn_Click"/>
    <asp:Button runat="server" ID="BatCancel_Btn" class="btn btn-outline-danger" Text="批量取消审核" OnClick="BatCancel_Btn_Click"/>
    <input type="button" value="导出Excel" class="btn btn-outline-info" onclick="ZLHelper.ToExcelByID()"/>
</div>
</asp:Content>
