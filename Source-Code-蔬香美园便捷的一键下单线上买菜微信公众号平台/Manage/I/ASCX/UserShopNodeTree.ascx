...
<div class="menu_tit pl-2"><i class="fa fa-chevron-down"></i> 店铺商品</div>
<div id="nodeNav">
...
<button type="button" id="searchBtn" class="input-group-text" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Shop/ProductManage.aspx?souchtype=1&keyWord=" %>','keyWord');"><i class="fa fa-search"></i></button>
</div>
</div>
<div class="tvNavDiv">
