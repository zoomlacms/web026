<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShopGuide.ascx.cs" Inherits="ZoomLaCMS.Manage.I.ASCX.ShopGuide" %>
<div class="tvNavDiv">
...
<div class="input-group-append">
    <button class="input-group-text" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Shop/ProductManage.aspx?keyWord=" %>','keyWord');"><i class="fa fa-search"></i></button>
</div>
</div>
<div class="left_ul">
<ul>
    ...
    <li><a href="/User/Shopfee/OrderList"><%=lang.LF("代购订单")%></a></li>
