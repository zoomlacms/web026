...
<div id="nodeNav">
<div class="menu_tit"><i class="fa fa-chevron-down"></i> 组织结构</div>
...
<button class="input-group-text" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Content/ContentManage.aspx?keyWord=" %>','keyWord');"><span class="fa fa-search"></span></button>
</div>
</div>--%>
