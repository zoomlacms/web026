<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SenTree.ascx.cs" Inherits="ZoomLaCMS.Manage.I.ASCX.SenTree" %>
<div class="m_left_ul open">
<ul class="m_left_ulin open" id="menu9_10">
<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-chevron-down"></i> <%=Resources.L.舆情管理 %></p>
...
<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-chevron-down"></i> <%=Resources.L.数据管理 %></p>
<ul id="menu9_10_ul2">
