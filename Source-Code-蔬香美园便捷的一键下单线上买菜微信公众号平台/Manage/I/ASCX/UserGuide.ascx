...
<div class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.会员管理%></div>
...
<button class="input-group-text" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"User/UserManage.aspx?keyWord=" %>','keyWord');"><i class="fa fa-search"></i></button>
