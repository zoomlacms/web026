...
<div class="menu_tit" onclick="wxclick(this);"><i class="fa fa-chevron-down"></i> <%=Resources.L.微信配置%></div>
...
<li class="pl-0"> <p class="menu_tit laybtn below"><i class="fa fa-chevron-down"></i> 微信公众号</p></li>
