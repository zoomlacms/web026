...
<div class="menu_tit"><i class="fa fa-chevron-down"></i> 商品管理</div>
<div id="nodeNav">
...
<div class="input-group-append">
    <button type="button" id="searchBtn" class="input-group-text" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Shop/ShopRecycler.aspx?keyWord=" %>','keyWord');"><i class="fa fa-search"></i></button>
</div>
</div>
<div class="tvNavDiv">
