...
<ol id="BreadNav" class="breadcrumb navbar-fixed-top">
    ...
    <li class="breadcrumb-item">
        ...
        <a href="javascript:;" onclick="user.sel('User', 'user', 'noplat|1')" class="btn btn-xs btn-info"><i class="fa fa-user-plus"></i>添加成员</a>
    </li>
...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="VideoInfo.aspx?id=<%#Eval("UserID") %>"><i class="fa fa-pencil" title="修改"></i></a>
                    <asp:LinkButton runat="server" CommandName="del" CommandArgument='<%#Eval("UserID") %>' OnClientClick="return confirm('确定从该企业移除吗？');"><i class="fa fa-trash-o" title="移除"></i>移除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
