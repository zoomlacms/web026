    ...
    <ZL:ExGridView ID="EGV" runat="server" PageSize="20" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="EGV_RowDataBound"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="ShowTouTiaoContent.aspx?ID=<%#Eval("ID") %>" ><i class="fa fa-list-ul"></i>详情</a>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="del" OnClientClick="return confirm('此操作不会删除头条号中的信息，确认删除吗？')" ><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
