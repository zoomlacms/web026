        ...
        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="20" EnableTheming="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="">
                    <ItemTemplate>
                        <a href="AddMisModel.aspx?ID=<%#Eval("ID") %>"><i class="fa fa-pencil" title="修改"></i></a>
                        <asp:LinkButton CommandName="del" CommandArgument='<%# Eval("ID") %>' runat="server"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </ZL:ExGridView>
