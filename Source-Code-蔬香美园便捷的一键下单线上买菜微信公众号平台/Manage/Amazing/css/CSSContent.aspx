...
<div class="tab-pane tab0" id="tab0">
    <table class="table table-bordered">
       <tr><td class="td_m">文件名称</td><td><ZL:TextBox runat="server" ID="Name_T" AllowEmpty="false" MaxLength="20" class="form-control max20rem"/></td></tr>
       <tr><td>备注</td><td><asp:TextBox runat="server" ID="Remind_T" TextMode="MultiLine" class="form-control m50rem_50" /></td></tr>
       <tr><td>是否启用</td><td><input type="checkbox" runat="server" id="ZStatus_Chk" checked="checked" class="switchChk"/></td></tr>
       <tr><td>标签引用</td><td><asp:TextBox runat="server" ID="Quote_Label_T" class="form-control m50rem_50" disabled="disabled" /></td></tr>
   </table>
</div>
...
<div class="" id="list_wrap">
        <table class="table table-bordered" id="css_listwrap">
            <tr>
                ...
                <td style="width:180px;">别名</td>
                <td style="width:180px;">选择器</td>
                <td>css内容</td>
            </tr>
