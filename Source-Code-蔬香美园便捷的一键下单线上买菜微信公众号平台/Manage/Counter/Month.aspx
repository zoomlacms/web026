<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Month.aspx.cs" Inherits="ZoomLaCMS.Manage.Counter.Month" MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="Month.aspx", text="日统计报表",addon="" }}
		)
    %>
        ...
        <div class="col-12 col-md-4 col-lg-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="fa fa-calendar"></i> <%:CDate.Month %>月统计</h3>
                </div>
                <ul class="card-body">
