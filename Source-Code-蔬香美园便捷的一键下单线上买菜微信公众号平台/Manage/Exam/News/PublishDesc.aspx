...
<ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="/Rss/ViewPublish?Pid=<%#Eval("ID") %>" target="_blank" title="前台浏览"><i class="fa fa-globe" title="浏览"></i></a><span class="sperspan"></span>
                            <asp:LinkButton runat="server" CommandName="Edit2" CommandArgument='<%#Eval("ID") %>'><i class="fa fa-pencil" title="修改"></i></asp:LinkButton><span class="sperspan"></span>
                            <asp:LinkButton runat="server" CommandName="Del2" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('确定要删除?');" ToolTip="删除"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
                            <a href="NewsDiv.aspx?Pid=<%#Eval("ID") %>" title="版面管理"><i class="fa fa-magic" title="管理"></i>版面管理</a><span class="sperspan"></span>
