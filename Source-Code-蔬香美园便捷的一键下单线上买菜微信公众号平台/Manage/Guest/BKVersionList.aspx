            ...
            <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" PageSize="10" OnRowDataBound="EGV_RowDataBound" OnPageIndexChanging="EGV_PageIndexChanging"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="/Baike/Details?EditID=<%#Eval("ID") %>" target="_blank" ><i class="fa fa-eye" title="预览"></i></a>
                            <a href="/Baike/BKEditor?EditID=<%#Eval("ID") %>&mode=admin" target="_blank" ><i class="fa fa-pencil" title="修改"></i></a>
                            <asp:LinkButton runat="server" OnClientClick="return confirm('确实要删除吗？');" CommandArgument='<%#Eval("ID") %>' CommandName="Del" CausesValidation="false" ><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
