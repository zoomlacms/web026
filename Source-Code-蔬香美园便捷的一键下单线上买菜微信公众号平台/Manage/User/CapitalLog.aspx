<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CapitalLog.aspx.cs" Inherits="ZoomLaCMS.Manage.User.CapitalLog"  MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
        ...
        <li class="breadcrumb-item"><a href='<%=customPath2 %>User/UserManage.aspx'><%=Resources.L.会员管理 %></a></li>
		<li class='breadcrumb-item active'><%=Resources.L.财务流水 %></li>
        ...
        <div id="sel_box">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                        <asp:LinkButton runat="server" CssClass="btn btn-outline-secondary" ID="LinkButton1" OnClick="Search_Btn_Click" Text="<%$Resources:L,搜索 %>"></asp:LinkButton>
    ...
    <li data-type="1" class="nav-item"><a class="nav-link" href="?type=1"><%=Resources.L.余额操作 %></a></li>
    <li data-type="3" class="nav-item"><a class="nav-link" href="?type=3"><%=Resources.L.积分记录 %></a></li>
    <li data-type="2" class="nav-item"><a class="nav-link" href="?type=2"><%=Resources.L.银币记录 %></a></li>
    <li data-type="4" class="nav-item"><a class="nav-link" href="?type=4"><%=Resources.L.点券记录 %></a></li>
    <li data-type="6" class="nav-item"><a class="nav-link" href="?type=6"><%=Resources.L.信誉值记录 %></a></li>
    <li data-type="7" class="nav-item"><a class="nav-link" href="?type=7"><%=Resources.L.订单流水 %></a></li></ul>
    <div id="tab_con" class="tab-content container-fluid pr-0">
    ...
    <asp:Button ID="Dels_Btn" runat="server" CssClass="btn btn-outline-danger" Text="<%$Resources:L,批量删除 %>" OnClick="Dels_Btn_Click" OnClientClick="return confirm('是否删除选定记录!')" />
    </div>
    <script>
        //选择滑动门
        function CheckType(id) {
            $("[data-type='"+id+"']").find("a").addClass('active');
        }
		//折叠搜索
