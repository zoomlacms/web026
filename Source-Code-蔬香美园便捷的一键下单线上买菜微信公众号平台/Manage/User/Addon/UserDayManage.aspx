...
<div class="row sysRow list_choice table-responsive">
  <table class="table table-striped table-bordered table-hover">
    <tr class="tdbgleft d-flex flex-row-reverse">
      <td> <%=Resources.L.选择日期 %>：
        ...
        <asp:Button ID="Button1" runat="server" Text="<%$Resources:L,搜索 %>" class="btn btn-outline-info"  onclick="Button1_Click"/></td>
    </tr>
  </table>
  <div class="container-fluid pr-0">
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr class="tdbgleft table_tr">
      <th width="10%">ID</th>
      <th width="20%"><%=Resources.L.时间 %></th>
      <th width="30%"><%=Resources.L.节日标题 %></th>
      <th width="10%"><%=Resources.L.用户 %></th>
      <th width="10%"><%=Resources.L.邮件发送状态 %></th>
      <th width="10%"><%=Resources.L.短信发送状态 %></th>
      <th width="10%"><%=Resources.L.操作 %></th>
    </tr>
