<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegularList.aspx.cs" Inherits="ZoomLaCMS.Manage.User.Addon.RegularList" MasterPageFile="~/Manage/I/Index.master" %>
...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a  href="AddRegular.aspx?id=<%#Eval("ID") %>"><i class="fa fa-pencil" title="修改"></i></a>
