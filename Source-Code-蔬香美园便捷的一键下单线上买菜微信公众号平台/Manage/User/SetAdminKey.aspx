<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetAdminKey.aspx.cs" Inherits="ZoomLaCMS.Manage.User.SetAdminKey"  MasterPageFile="~/Manage/I/Index.master" %>
...
new Bread(){url="/{manage}/User/SetAdminKey.aspx", text="动态口令加密"}
}
) %>
...
<div id="maindiv" runat="server" visible="false">
    ...
    <div class="text-center margin_t10">
        <asp:Button ID="EnableKey_B" CssClass="btn btn-outline-info m-2" Text="点击启用" disabled="disabled" runat="server" OnClientClick="return confirm('确定启用验证器吗?')" OnClick="EnableKey_B_Click" />
    </div>
...
<div id="EditDiv" runat="server" visible="false">
    ...
    <div id="checkcode" style="display:none;">
        ...
        <div class="text-center">
            ...
            <asp:Button ID="Check_B" Text="获取" runat="server" CssClass="btn btn-outline-info" OnClick="Check_B_Click" />
            <button type="button" onclick="CloseCheck()" class="btn btn-outline-info">取消</button>
        </div>
    </div>
</div>
</div>
