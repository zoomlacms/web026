...
<asp:Content runat="server" ContentPlaceHolderID="Content">
	...
	<div class="row sysRow table-responsive">
        <table class="table table-striped table-bordered sys_table">
            ...
            <tr>
                <th class="text-right w12rem_lg" >用户名<span class="text-danger">*</span></th>
                <td>
                 ...
                 <th class="text-right w12rem_lg">工号</th>
                <td>
           ...
           <%-- <asp:Literal ID="lblHtml" runat="server"></asp:Literal>--%>
            ...
            <tr>
                <td colspan="4" class="text-center">
                    <asp:Button ID="btnSave" runat="server" CssClass="btn btn-outline-info" TabIndex="31"  Text="保存会员信息" OnClick="btnSave_Click"/>
