...
<table class="table table-bordered sys_table">
    ...
    <tr><th>CRM客户类别</th><td>
        <asp:Repeater runat="server" ID="CRM_RPT">
            <ItemTemplate>
                <label><input type="checkbox" name="crm_chk" value="<%#Eval("ID") %>"/><%#Eval("value") %></label>
            </ItemTemplate>
        </asp:Repeater>
        </td></tr>
    <tr>
	...
	<tr>
		<td></td>
		<td>
			<asp:Button ID="BtnSend" runat="server" Text="发送短信" OnClick="BtnSend_Click" OnClientClick="return subCheck();" class="btn btn-outline-info" />
		</td>
	</tr>
</table>
</div>
