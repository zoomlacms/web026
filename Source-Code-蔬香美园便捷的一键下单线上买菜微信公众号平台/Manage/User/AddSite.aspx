...
<div class="row sysRow list_choice">
    <table class="table table-striped table-bordered sys_table">
            <tr>
                <th class="w12rem_lg">站点名</th>
                <td><asp:TextBox ID="Name_T" CssClass="form-control max20rem" runat="server"></asp:TextBox>
            ...
            <tr>
                <th>域名</th>
                <td><asp:TextBox ID="Demon_T" runat="server" CssClass="form-control max20rem"></asp:TextBox>
            ...
            <tr>
                <th>IP</th>
                <td><asp:TextBox ID="IP_T" runat="server" CssClass="form-control max20rem"></asp:TextBox>
            ...
            <tr>
				<td></td>
                <td colspan="2">
                    <asp:Button ID="Save_B" runat="server" Text="保存" OnClick="Save_B_Click" CssClass="btn btn-outline-info" />
