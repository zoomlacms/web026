    ...
    <ZL:ExGridView ID="EGV" runat="server" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" OnPreRender="EGV_PreRender"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a href="AddManage.aspx?ID=<%#Eval("AdminID") %>"><i class="fa fa-pencil" title="修改"></i></a>
                    <asp:LinkButton runat="server" CommandName="del2" OnClientClick="return confirm('确实删除此管理员?');" CommandArgument='<%# Eval("AdminId")%>'><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
                    <a href="RegionManage.aspx?guid=<%#Eval("AdminId") %>_<%#Eval("AdminName") %>"><i class="fa fa-key" title="权限"></i>区域订单权限</a>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
        </Columns>
