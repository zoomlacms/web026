...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol class="breadcrumb navbar-fixed-top">
        ...
        <div id="help" class="pull-right text-center pr-2"><a href="javascript:;" onclick="selbox.toggle();" id="sel_btn" class="help_btn"><i class="fa fa-search"></i></a></div>
    ...
    <asp:Button ID="CheckDepos_B" CssClass="btn btn-outline-info" runat="server" OnClick="CheckDepos_B_Click" OnClientClick="return confirm('要确认选定出金吗?');" Text="批量确认" />
