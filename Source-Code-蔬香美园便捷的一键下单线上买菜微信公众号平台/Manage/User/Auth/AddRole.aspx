...
new Bread(){url="", text="添加角色"}
	...
	<div class="row">
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 list_choice">
        <asp:HiddenField runat="server" ID="Literal1_Hid" Value="添加角色" />
	
  <table class="table table-striped table-bordered table-hover" align="center">
    <tr>
      <td class="spacingtitle" colspan="2"><asp:Literal ID="LblTitle" Text="添加角色"  runat="Server"></asp:Literal></td>
    </tr>
    <tr class="tdbg">
      <td class="text-right w12rem_lg"> 角色名：</td>
...
<div class="alert alert-light"> 
    ...
    <asp:Button ID="btnSave" runat="server" Text="保存角色"  OnClick="Button2_Click" class="btn btn-outline-info" />
