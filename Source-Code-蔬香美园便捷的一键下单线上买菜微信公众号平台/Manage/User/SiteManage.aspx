            ...
            <ZL:Repeater ID="Site_RPT" OnItemCommand="Site_RPT_ItemCommand" runat="server" PagePre="<tr><td><input type='checkbox' id='AllID_Chk'></td><td colspan='12'><div class='text-center'>" PageEnd="</div></td></tr>">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("sip") %></td>
                        <td>
                            <a href="AddSite.aspx?domain=<%#Eval("domain") %>"><i class="fa fa-pencil" title="修改"></i></a>
                            <asp:LinkButton runat="server" CommandName="Del" CommandArgument='<%#Eval("domain") %>' OnClientClick="return confirm('是否删除!')"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
            </ZL:Repeater>
