...
<asp:Button runat="server" ID="BatRe_Btn" class="btn btn-outline-info" Text="恢复正常" OnClick="BatOperation_Btn_Click" CommandName="normal"/>
<asp:Button runat="server" ID="BatBack_Btn" class="btn btn-outline-info" Text="批量退订" OnClick="BatOperation_Btn_Click" CommandName="back"/>
<asp:Button runat="server" ID="BatStop_Btn" class="btn btn-outline-info" Text="批量停用" OnClick="BatOperation_Btn_Click" CommandName="stop" />
<asp:Button ID="Dels_Btn" runat="server" CssClass="btn btn-outline-danger" Text="批量删除" OnClick="Dels_Btn_Click" OnClientClick="return confirm('是否确定删除选定项!')" />
</div>
