    ...
    <ZL:ExGridView ID="EGV" runat="server" AllowPaging="true" OnPageIndexChanging="EGV_PageIndexChanging" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:TemplateField HeaderText="模板名称">
                <ItemTemplate><i class="fa fa-code"></i><a href="MailSysTlpEdit.aspx?TlpName=<%# HttpUtility.UrlEncode(Eval("Name","")) %>" ><%# Eval("Name") %></a></ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="MailSysTlpEdit.aspx?TlpName=<%# HttpUtility.UrlEncode(Eval("Name","")) %>" ><i class="fa fa-pencil" title="修改"></i></a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
