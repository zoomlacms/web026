...
<table id="FieldList" class="table table-striped table-bordered table-hover">
    <tr class="gridtitle">
      <td><strong><%=Resources.L.字段名 %></strong></td>
      <td><strong><%=Resources.L.字段别名 %></strong></td>
      <td><strong><%=Resources.L.字段类型 %></strong></td>
      <td><strong><%=Resources.L.字段级别 %></strong></td>
      <td><strong><%=Resources.L.是否必填 %></strong></td>
      <td><strong><%=Resources.L.排序 %></strong></td>
    ...
    <asp:Repeater ID="RepModelField" runat="server" OnItemCommand="Repeater1_ItemCommand">
      <ItemTemplate>
          <tr style="text-align: center;" ondblclick="editField('<%# Eval("FieldID") %>');">
              ...
              <td align="center">
                  <a href="javascript:;" onclick="editField('<%# Eval("FieldID") %>');" class="option_style"><i class="fa fa-pencil" title="修改"></i></a>
