...
<%=Call.SetBread(new Bread[] {
    ...
    %>
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="false" PageSize="10" IsHoldState="false" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover list_choice" EnableTheming="False" EnableModelValidation="True" EmptyDataText="无相关数据！！" OnRowCommand="EGV_RowCommand" OnPageIndexChanging="EGV_PageIndexChanging">
        <Columns>
...
<%--            <asp:TemplateField HeaderText="内容">
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="MsgInfo.aspx?id=<%#Eval("ID") %>"><i class="fa fa-pencil" title="修改"></i></a>
                    ...
                    <a href="MsgList.aspx?suid=<%#Eval("UserID") %>&ruid=<%#Eval("ReceUser") %>" title="查看聊天详情" target="_blank" ><i class="fa fa-eye" title="查看"></i>查看详情</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
