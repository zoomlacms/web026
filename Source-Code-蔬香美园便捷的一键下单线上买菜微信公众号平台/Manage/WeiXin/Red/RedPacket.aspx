<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RedPacket.aspx.cs" Inherits="ZoomLaCMS.Manage.WeiXin.RedPacket" MasterPageFile="~/Manage/I/Index.Master" %>
<asp:Content runat="server" ContentPlaceHolderID="head"><title>红包列表</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
		new Bread("Home.aspx","移动微信"),	
        new Bread() {url="RedPacket.aspx", text="红包列表<a href='RedPacketAdd.aspx?appid="+ AppID +"'>[添加红包]</a>",addon="" }}
		)
    %>
