<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WxUserList.aspx.cs" Inherits="ZoomLaCMS.Manage.WeiXin.WxUserList"  MasterPageFile="~/Manage/I/Index.master" %>
...
<%--            <asp:TemplateField HeaderText="用户组">
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="javascript:;" title="更新用户信息" data-oid="<%#Eval("OpenID") %>" class="wxoption"><span class="fa fa-refresh"></span>更新用户信息</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
