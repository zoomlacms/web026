...
<div class="row sysRow list_choice table-responsive">
    <table class="table table-striped table-bordered sys_table">
        <tr><th class="w12rem_lg">所属公众号</th><td><asp:DropDownList runat="server" ID="WXAPP_DP" DataTextField="Alias" DataValueField="ID" class="form-control max20rem"></asp:DropDownList></td></tr>
        <tr><th>信息名称</th><td><ZL:TextBox runat="server" ID="Alias_T" class="form-control max20rem" AllowEmpty="false"/></td></tr>
        <tr>
            <th>信息类型</th>
            <td>
                <label>
