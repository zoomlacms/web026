...
<td align="center"><a href="UpdateCode.aspx?ID=<%#Eval("ID") %>&Type=<%#Eval("Type") %>" ><i class="fa fa-pencil" title="修改"></i></a>  
 <asp:LinkButton ID="linkBtn" runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="Del"  OnClientClick=" return confirm('你确定要删除吗');"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton> </td> 
</tr>
</ItemTemplate>
