...
<tr>
<th scope="row" class="w12rem_lg">别名</th>
<td><asp:TextBox runat="server" ID="Alias_T" CssClass="form-control max20rem"/>
...
<tr>
<th scope="row">操作</th>
<td><asp:Button runat="server" ID="Save_Btn" Text="保存设置" OnClick="Save_Btn_Click"  CssClass="btn btn-outline-info"/>
