...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item"><a class="nav-link" href="#tab2" data-toggle="tab">其它图标</a></li>
</ul>
<div class="tab-content">
	...
	<div class="row">
		...
		<a class="fonts_list p-3 ml-3" href="http://www.ziti163.com/webfont" target="_blank"><div title="更多webfont" class="ZoomlaXSongExtraLight">更多Webfont <i class="fa fa-plus-square-o"></i></div></a>
    </div>
	</div>
