...
<table class="table table-striped table-bordered table-hover sys_table">
	...
	<tr>
        <td></td>
		<td>
			<asp:Button ID="EBtnSubmit" Text="保存" OnClick="EBtnSubmit_Click" runat="server" class="btn btn-outline-info" />
			<input name="Cancel" type="button" id="Cancel" value="取消" onclick="javascript: history.go(-1)" class="btn btn-outline-info" />
		</td>
	</tr>
</table>
</div></div>
