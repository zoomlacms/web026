...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
	<%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="", text="分类管理<a href='ProjectsAddType.aspx'>[添加类型]</a>",addon="" }},
		Call.GetHelp(45)
		)
    %>
    <ZL:ExGridView runat="server" ID="EGV" AllowPaging="true" AllowSorting="false"  class="table table-striped table-bordered table-hover list_choice" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <asp:LinkButton ID="LbtnUpdate" runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="Update"><i class="fa fa-pencil" title="修改"></i></asp:LinkButton>
                    <asp:LinkButton ID="LbtnDel" runat="server" OnClientClick="return confirm('您确定要删除吗？')" CommandArgument='<%#Eval("ID") %>' CommandName="Del"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton> 
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
