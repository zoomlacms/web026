...
<button class="navbar-toggler collapsed d-block d-sm-none ml-auto mr-2" type="button" data-toggle="collapse" data-target="#navbarsExampleDefault" aria-controls="navbarsExampleDefault" aria-expanded="false" aria-label="Toggle navigation">
...
<div class="m_top_bottom nav-scroller">
	...
	<ul class="menu2 open nav nav-underline sys_overhid">
		...
		<li>
			<div class="btn-group sys_posit_in menu2_4 mt-1">
        ...
        <li class="menu2_5">
			<div class="btn-group sys_posit_in mt-1">
	...
	<ul class="menu3 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu3_5" onclick="showleft('menu3_5','Shop/SaleReport/SaleByDay.aspx')"><%=Resources.L.销售统计 %></a></li>
	...
	<ul class="menu11 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu11_6" onclick="showleft('menu11_1','Template/CloudLead.aspx')"><%=Resources.L.模板云台 %></a></li>
	...
	<ul id="menu1_2" class="m_left_ulin">
		...
		<div class="input-group">
		 <input type="text" id="searchkeyword" class="form-control" onkeydown="return ASCX.OnEnterSearch('Guest/AllSearch.aspx?keyWord=',this);" placeholder="<%=Resources.L.导航标题 %>" />
		  ...
		  <button class="input-group-text" type="button" onclick="ASCX.Search('Config/FuncSearch.aspx?keyWord=','searchkeyword');"><span class="fa fa-search"></span>
		  </div>
		</div>
		<li id="menu1_2_1"><a href="javascript:;" data-url="Config/SearchFunc.aspx"><%=Resources.L.管理导航 %></a></li>
			...
			<div id="menu2" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu2_9">
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button class="input-group-text" type="button" onclick="ASCX.Search('Guest/AllSearch.aspx?keyWord=','tiekeyword');"><span class="fa fa-search"></span></button>
						</div>
					</div>
				</ul>
			...
			<div id="menu3" class="m_left_ul">
				...
				<ul id="menu3_3" class="m_left_ulin">
					...
					<li id="menu3_3_6" role="presentation" class="dropdown">
						...
						<ul class="dropdown-menu" role="menu" style="width:140px;">
							...
							<li><a href="javascript:;" data-url="Shop/OrderList.aspx?OrderType=11" style="border-bottom:none;">捐赠订单</a></li>
						</ul>
					</li>
				...
				<ul id="menu3_5" class="m_left_ulin">
					...
					<li id="menu3_5_1"><a href="javascript:;" data-url="Shop/SaleReport/SaleByDay.aspx">按日统计</a></li>
					<li id="menu3_5_2"><a href="javascript:;" data-url="Shop/SaleReport/SaleByMonth.aspx">按月统计</a></li>
		...
		<ul>
			...
			<div id="menu6" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu6_2">			
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button id="Ok" class="input-group-text" type="button" onclick="ASCX.Search('User/AdminManage.aspx?keyWordss=','keyWordss');"><span class="fa fa-search"></span></button>
						</div>
					</div>						<li id="menu6_2_1"><a href="javascript:;" data-url="User/AdminManage.aspx"><%=Resources.L.管理员管理 %></a></li>
			...
			<div id="menu8" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu8_3">
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button id="NodeBtn" class="input-group-text" type="button" onclick="ASCX.Search('Content/Node/NodeSearch.aspx?NodeID=','NodeSkey_t');"><span class="fa fa-search"></span></button>
						</div>
					</div>
				</ul>
				...
				<ul class="m_left_ulin" id="menu8_5">
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button id="Spec_btn" class="input-group-text" type="button" onclick="ASCX.Search('Content/SpecialManage.aspx?skey=','SpecKey_t');"><span class="fa fa-search"></span></button>
						</div>
					</div>
				</ul>
			...
			<div id="menu9" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu9_4" style="height: 700px; overflow: auto;">
					...
					<li id="menu9_4_1"><a href="javascript:;" data-url="/AdminMVC/CRM/ClientList">客户管理</a></li>
					<li id="menu9_4_2"><a href="javascript:;" data-url="/AdminMVC/CRM/Contact">联系人</a></li>
                    <li id="menu9_4_3"><a href="javascript:;" data-url="/AdminMVC/CRM/CType">客户类别</a></li>
					<li id="menu9_4_4"><a href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=11">模型管理</a></li>
				</ul>
			...
			<div id="menu10" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu10_6">
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button class="input-group-text" type="button" onclick="ASCX.Search('design/SceneList.aspx?KeyWord=','scence_text');" ><span class="fa fa-search"></span></button>
						</div>
					</div>
	...
	<div class="FrameTabs_bg">
		<div class="FrameTab_nav">
			<div id="FrameTabs" style="overflow: hidden; width: 100%;">
				...
				<div class="tab-strip-wrap nav-scroller">
					<ul class="tab-strip pull-left nav" id="tab_ul" style="position: fixed; background: #FFF;">
						...
						<li class="end addnav" id="newFrameTab"><a title="<%=Resources.L.新选项卡%>" href="javascript:"><span class="fa fa-plus"></span></a></li>
					</ul>
    ...
    <div class="manage_mobilemenu">
    	...
    	<div class="manage_mobilemenu_c">
            <ul>
                ...
                <li><a href="/AdminMVC/COM/Logout" title="退出系统"><i class="fa fa-power-off"></i> 退出系统</a></li>
            </ul>
		</div>
    </div>
...
$("#navbarsExampleDefault").removeClass("in");
