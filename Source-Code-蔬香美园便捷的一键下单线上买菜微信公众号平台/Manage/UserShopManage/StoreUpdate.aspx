...
new Bread(){url="", text="店铺信息"}
                ...
                <td>
					<div class="input-group mb-3">
					  ...
					  <div class="input-group-append">
						<a href="/Store/StoreIndex?id=<%:Mid %>" class="btn btn-info <%:Mid==0?"hidden":"" %>" target="_blank"><i class="fa fa-eye"></i></a>
					  </div>
					</div>
                </td>
            </tr>
    ...
    <div class="Conent_fix">
        <asp:Button ID="Esubmit" CssClass="btn btn-outline-info" runat="server" Text="保存信息" OnClick="Esubmit_Click" />
