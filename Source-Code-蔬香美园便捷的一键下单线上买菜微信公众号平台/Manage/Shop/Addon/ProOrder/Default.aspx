...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div id="BreadDiv" class="mysite">
		<ol id="BreadNav" class="breadcrumb navbar-fixed-top">
			...
			<li class="breadcrumb-item"><a href='<%=CustomerPageAction.customPath2+"Shop/ProductManage.aspx" %>'>商品管理</a></li>
			<li class="breadcrumb-item"><a href='<%=Request.RawUrl %>'>申购单列表</a></li>
...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="订单编号" ItemStyle-CssClass="w12rem_lg">
            <ItemTemplate>
...
<%--        <asp:TemplateField HeaderText="订单状态">
        ...
        <asp:BoundField DataField="AddTime" DataFormatString="{0:yyyy年MM月dd日}" HeaderText="创建时间" ItemStyle-CssClass="w12rem_lg"/>
        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="w12rem_lg">
            <ItemTemplate>
                <a href="ProOrderInfo.aspx?id=<%#Eval("ID") %>"><i class="fa fa-pencil" title="修改"></i></a>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</ZL:ExGridView>
<div class="alert alert-light">
<a href="../Material/MatReport.aspx" class="btn btn-outline-info">查看原料汇总</a>
<asp:Button runat="server" ID="BatSend_Btn" Text="批量发货" OnClick="BatSend_Btn_Click" class="btn btn-outline-info" />
