...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="max20rem">
            <ItemTemplate>
              <a href="<%#CustomerPageAction.customPath2+"/Shop/OrderListInfo.aspx?ID="+Eval("OrderID") %>"><i class="fa fa-paper-plane"></i>订单</a>
              <a href="OrderSettle.aspx?sid=<%#Eval("ID") %>&ID=<%#Eval("OrderID") %>"><i class="fa fa-eye"></i>详情</a>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</ZL:ExGridView>
