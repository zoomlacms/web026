<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDeliverType.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.AddDeliverType" MasterPageFile="~/Manage/I/Index.master" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
<link type="text/css" href="/dist/css/bootstrap-switch.min.css" rel="stylesheet" />
<script type="text/javascript" src="/dist/js/bootstrap-switch.js"></script>
	<%=Call.SetBread( new Bread[] {
	new Bread("../../ProductManage.aspx","商城管理"),
	new Bread("DeliverType.aspx","商城设置"),
	new Bread("DeliverType.aspx","运费模板管理"),
	new Bread(){url="", text="添加运费模板"}
	}) %>
<title>运费模板</title>
</asp:Content>
...
<div class="row sysRow list_choice">
    <table class="table table-bordered table-striped">
        <tr><th class="td_l">模板名称</th><td>
            <ZL:TextBox runat="server" ID="TlpName_T" CssClass="form-control max20rem" MaxLength="100" AllowEmpty="false" /></td></tr>
        <tr><th>计价方式</th><td>
     ...
     <%--      <label><input type="radio" value="2" name="pricemod_rad"/>按重量</label></td>--%>
       ...
       <%--         <div style="border-bottom:1px solid #ddd;padding-bottom:5px;">
        ...
        <tr><th>备注(买家可见):</th><td><asp:TextBox runat="server" ID="Remind_T" TextMode="MultiLine" CssClass="form-control max20rem" /></td></tr>
        <tr><th>备注(仅卖家可见):</th><td><asp:TextBox runat="server" ID="Remind2_T" TextMode="MultiLine" CssClass="form-control max20rem "/></td></tr>
        <tr><td></td><td><asp:Button runat="server" ID="Save_Btn"  Text="保存信息" OnClientClick="return scope.save();" OnClick="Save_Btn_Click" CssClass="btn btn-outline-info"/></td></tr>
    </table>
</div>
</div>
