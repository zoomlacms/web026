        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
				...
				<div class="alert alert-light">
                    <a href="PromoAdd.aspx?id=<%#Eval("ID") %>"><i class="fa fa-pencil"></i>修改</a>
                    <asp:LinkButton runat="server" CommandName="del" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('确认删除这条数据吗?');"><i class="fa fa-trash-o"></i>删除</asp:LinkButton>
				</div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
