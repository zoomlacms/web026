<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrderModel.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.AddOrderModel"MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread("SystemOrderModel.aspx?Type="+SType,"订单模型管理"),						
        new Bread() {url="", text="添加系统订单字段",addon="" }}
		)
    %>
...
<div class="row sysRow list_choice">
    <table class="table table-striped table-bordered table-hover sys_table">
        ...
        <tr>
            <th class="w12rem_lg">字段别名</th>
            <td>
                <asp:TextBox class="form-control max20rem" ID="Alias" runat="server" MaxLength="20" onkeyup="Getpy('Alias','Name')"></asp:TextBox><font color="#ff0066">*</font><span class="tips"> 如：标题</span>
            </td>
        </tr>
        <tr>
            <th>字段名称</th>
            <td>
                <asp:TextBox class="form-control max20rem" ID="Name" MaxLength="50" runat="server"></asp:TextBox>
        ...
        <tr>
            <th>字段提示</th>
            <td>
                <asp:TextBox class="form-control max20rem" ID="Tips" MaxLength="50" runat="server"></asp:TextBox>
        ...
        <tr>
            <th>字段描述</th>
            <td>
                <asp:TextBox class="form-control max20rem" ID="Description" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
				<div class="input-group mb-3">
				  <asp:TextBox class="form-control max20rem" ID="TextBox1" runat="server" Columns="10" MaxLength="4">10</asp:TextBox>
        ...
        <tbody id="DivTextType">
            <tr>
                <th>文本框长度</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>是否为密码</th>
            ...
            <tr>
                <th>默认值</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TextType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
        </tbody>
        <!--  多行文本(不支持Html)    -->
        <tbody id="DivMultipleTextType" style="display: none">
            <tr>
                <th>显示的宽度</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="MultipleTextType_Width" runat="server" Columns="10"
            ...
            <tr>
                <th>显示的高度</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="MultipleTextType_Height" runat="server" Columns="10"
        ...
        <tbody id="DivMultipleHtmlType" style="display: none">
            ...
            <tr>
                <th>显示的宽度</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="MultipleHtmlType_Width" runat="server" Columns="10"
            ...
            <tr>
                <th>显示的高度</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="MultipleHtmlType_Height" runat="server" Columns="10"
        ...
        <tbody id="DivOptionType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-contro max20reml" ID="RadioType_Content" runat="server" TextMode="MultiLine"
            ...
            <tr>
                <th>默认值</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="RadioType_Default" runat="server"></asp:TextBox>
        ...
        <tbody id="DivListBoxType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-contro max20reml" ID="ListBoxType_Content" runat="server" TextMode="MultiLine"
                        Columns="40" Rows="6"></asp:TextBox>
                    <span class="text-danger">*</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" class="text-center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox class="form-contro max20reml" ID="DateSearchRang" runat="server" TextMode="MultiLine"
        ...
        <tbody id="DivPicType" style="display: none">
            ...
            <tr>
                <th>允许上传的图片大小</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TxtSPicSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span class="text-danger">*</span>
                </td>
            </tr>
            <tr>
                <th>允许上传的图片类型</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TxtPicExt" runat="server" Columns="30"></asp:TextBox><span
                        class="text-danger">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
        <!--  多图片    -->
        <tbody id="DivMultiPicType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-contro max20reml" ID="TxtThumb" runat="server" Columns="20"></asp:TextBox><span
            ...
            <tr>
                <th>允许上传的图片大小</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TxtPicSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span class="text-danger">*</span>
                </td>
            </tr>
            <tr>
                <th>允许上传的图片类型</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TextImageType" runat="server" Columns="30"></asp:TextBox>
                    <span class="text-danger">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
        <!--  文件类型    -->
        <tbody id="DivSmallFileType" style="display: none" runat="server">
            <tr>
                <th>允许上传的文件大小</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TxtMaxFileSizes" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span class="text-danger">*</span>
                </td>
            </tr>
            <tr>
                <th>允许上传的文件类型</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TxtUploadFileTypes" runat="server" Columns="30"></asp:TextBox>
                    <span class="text-danger">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：rar|jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
        <!--  多文件类型    -->
        <tbody id="DivFileType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    ...
                    保存文件大小字段名：
                    <asp:TextBox class="form-contro max20reml" ID="TxtFileSizeField" runat="server" Columns="20"></asp:TextBox><br />
            ...
            <tr>
                <th>允许上传的文件大小</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TxtMaxFileSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span class="text-danger">*</span>
                </td>
            </tr>
            <tr>
                <th>允许上传的文件类型</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TxtUploadFileType" runat="server" Columns="30"></asp:TextBox>
                    <span class="text-danger">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
        ...
        <tbody id="DivOperatingType" style="display: none">
            <tr>
                <th>分行键入&nbsp;&nbsp;<br />
                    每个平台选项</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="TxtOperatingOption" runat="server" TextMode="MultiLine"
                        Columns="40" Rows="6"></asp:TextBox>
                    <span class="text-danger">*</span> <span style="color: blue">注：一行一个默认项</span>
                </td>
            </tr>
            <tr>
                <th>文本框长度</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="OperatingType_TitleSize" runat="server" Columns="10"
                        MaxLength="4">35</asp:TextBox><span class="text-danger">*</span>
                </td>
            </tr>
            <tr>
                <th>默认值</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="OperatingType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivSuperLinkType" style="display: none">
            <tr>
                <th>文本框长度</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="SuperLinkType_TitleSize" runat="server" Columns="10"
            ...
            <tr>
                <th>默认值</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="SuperLinkType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivNumType" style="display: none">
            <tr>
                <th>文本框长度</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="NumberType_TitleSize" runat="server" Columns="10"
            ...
            <tr id="showdec" style="display: none">
                ...
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="txtdecimal" runat="server" Text="0"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>默认值</th>
                <td>
                    <asp:TextBox class="form-contro max20reml" ID="NumberType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>搜索设置</th>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" class="text-center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox class="form-contro max20reml" ID="NumSearchRange" runat="server" TextMode="MultiLine"
                                    Columns="40" Rows="6"></asp:TextBox><br />
                            </td>
                            <td>
                                <font color="red">选择了自定范围时请输入此项内容,格式：范围名|范围<br />
        ...
        <tbody id="DivColorType" style="display: none" runat="server">
            <tr>
                <th>默认颜色值</th>
                <td>
                    <asp:TextBox class="form-control max20rem" ID="ColorDefault" runat="server" MaxLength="7" Columns="7" Style="font-size: 9pt; height: 15px;"></asp:TextBox>
        ...
        <tr>
            <td></td>
            <td height="50">
                <asp:Button ID="Button1" class="btn btn-outline-info" runat="server" Text="添加字段" OnClientClick="return isok()" OnClick="Button1_Click" />
                <input id="Button2" type="button" value="返回字段列表" class="btn btn-outline-info" onclick="javascript: window.location.href = 'SystemOrderModel.aspx?Type=shop'" />
