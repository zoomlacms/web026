                ...
                <div id="sel_box">
                    <div class="input-group">
						...
						<div class="input-group-append">
							<span class="input-group-text" title="支持多条件查询"><i class="fa fa-leaf"></i></span>
					  </div>
                    ...
                    <div class="input-group">
					  ...
					  <div class="input-group-append">
						 <button type="button" class="input-group-text btn btn-outline-info" onclick="cleartxt();"><i class="fa fa-recycle"></i>清除查询</button>
					  </div>
                    </div>
