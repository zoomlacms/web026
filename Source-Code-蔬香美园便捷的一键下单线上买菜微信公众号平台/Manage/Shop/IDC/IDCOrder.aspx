...
<div>
    <ol class="breadcrumb navbar-fixed-top">
		...
		<li class="breadcrumb-item"> <a href="IDCOrder_Add.aspx?<%=Request.QueryString %>">  <i class="fa fa fa-pencil"></i> 补订单</a></li>
        ...
        <asp:ListItem Value="proname">商品名称</asp:ListItem>
            ...
            <div class="input-group pull-left max20rem">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton runat="server" CssClass="btn btn-outline-dark" ID="souchok" OnClick="souchok_Click"><span class="fa fa-search"></span></asp:LinkButton>
                </span>
            </div>
        </div>
    </ol>
...
<div id="TableList" runat="server">
        ...
        <%--      <td>金额</td>--%>
            ...
            <ZL:ExRepeater runat="server" ID="RPT" OnItemCommand="RPT_ItemCommand" BoxType="dp"
             ...
             <%--           <td><%#Eval("OrdersAmount","{0:f2}")%></td>--%>
                        ...
                        <td>
                            <a href="javascript:;" title="详情"  onclick="openinfo('订单详记','<%#Eval("ID") %>','message');"><i class="fa fa-sticky-note-o"></i>详记</a>
                            <a href="javascript:;" title="内注"  onclick="openinfo('订单内注','<%#Eval("ID") %>','record');"><i class="fa fa-pencil"></i>内注</a>
                            <%#GetOP() %>
                            <asp:LinkButton runat="server" CommandName="del2" CommandArgument='<%#Eval("ID") %>'  OnClientClick="return confirm('确定要删除该订单吗');"><i class="fa fa-trash-o"></i>删除</asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
	...
	<div class="alert alert-light">
       ...
       <asp:LinkButton ID="ExportExcel_B" runat="server" CssClass="btn btn-outline-info" OnClick="ExportExcel_B_Click"><span class="fa fa-file-excel-o"></span> 导出Excel</asp:LinkButton>
   </div>
</div>
