        ...
        <div id="sel_box">	
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton runat="server" ID="Search_Btn" OnClick="Search_Btn_Click" class="btn btn-outline-dark"><i class="fa fa-search"></i></asp:LinkButton>
                </span>
            </div>
        </div>
	</ol>
        ...
        <asp:Repeater runat="server" ID="RPT">
            <ItemTemplate>
                <tr>
                    ...
                    <td><a href="SaleByProduct.aspx?nodeid=<%#Eval("NodeID") %>"><i class="fa fa-list"></i>查看详情</a></td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
    </table>
