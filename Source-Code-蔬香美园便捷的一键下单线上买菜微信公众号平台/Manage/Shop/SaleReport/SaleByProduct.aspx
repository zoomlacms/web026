...
<title>销售详情</title>
	...
	new Bread(){url="TotalSale.aspx", text="按商品统计"}
	}) %>
</asp:Content>
...
<div id="BreadDiv" class="container-fluid" style="height:10px;">
    <div class="row">
	    <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
            ...
            <li><a href="TotalSale.aspx">按商品统计</a></li>
...
<table class="table table-bordered table-striped">
    ...
    <asp:Repeater runat="server" ID="RPT">
        <ItemTemplate>
            <tr><td><a href="<%#CustomerPageAction.customPath2+"/Shop/ShowProduct.aspx?id="+Eval("ProID") %>" title="查看商品"><%#Eval("ProName") %></a></td><td><%#Eval("Pronum") %></td><td><%#Eval("NodeName") %></td><td><%#Eval("AllMoney","{0:f2}") %></td></tr>
        </ItemTemplate>
    </asp:Repeater>
</table>
</div>
