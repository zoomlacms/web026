        ...
        <div id="sel_box">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton runat="server" class="btn btn-outline-secondary" ID="Search_Btn" OnClick="BntSearch_Click"><i class="fa fa-search"></i></asp:LinkButton>
                </span>
            </div>
        </div>
    </ol>
    ...
    <ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="ZoneID" PageSize="20" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="">
                <ItemTemplate>
                    <a href="Advertisement.aspx?ZoneId=<%# Eval("ZoneID") %>" ><i class="fa fa-plus" title="添加"></i></a>
                    <a href="ADZone.aspx?ZoneId=<%# Eval("ZoneID") %>"><i class="fa fa-pencil" title="修改"></i></a>
                    ...
                    <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Copy" CommandArgument='<%# Eval("ZoneID") %>'><i class="fa fa-copy" title="复制"></i>复制</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton5" runat="server" CommandName="Clear" OnClientClick="return confirm('确定清空此版位？');" CommandArgument='<%# Eval("ZoneID") %>'><i class="fa fa-file-o" title="清空"></i>清空</asp:LinkButton>
