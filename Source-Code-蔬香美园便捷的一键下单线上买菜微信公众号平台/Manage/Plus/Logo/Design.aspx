	...
	<div class="list_choice">
		...
		<div class="row sysRow">
            <table class="table table-bordered table-striped sys_table">
                <tr><th class="w12rem_lg">别名</th><td><asp:TextBox runat="server" ID="Alias_T" class="form-control max20rem"/></td></tr>
                <tr><th>控件</th><td>
                    <button type="button" onclick="fabHelper.add('img');" class="btn btn-info"><i class="fa fa-plus"></i> 图片</button>
                    <button type="button" onclick="fabHelper.add('text');" class="btn btn-info"><i class="fa fa-plus"></i> 文字</button>
