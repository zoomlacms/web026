<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IconList.aspx.cs" Inherits="ZoomLaCMS.Manage.Plus.Logo.IconList" MasterPageFile="~/Manage/I/Index.Master" %>
...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="预览图">
            <ItemTemplate>
               <embed src="<%#Eval("VPath") %>" class="img_3rem"/>
            </ItemTemplate>
        </asp:TemplateField>
