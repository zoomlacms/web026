...
<div class="list_choice container-fluid table-responsive">
    ...
    <div class="panel col-12 col-md-4 col-lg-2 panel-primary">
        ...
        <div class="panel-body">
            <asp:ListBox ID="Zone_List" runat="server" Height="555px" SelectionMode="multiple" class="w-100 pl-1"></asp:ListBox>
        </div>
    </div>
      ...
      <%--  <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">我的好友</a></li>--%>
        ...
        <table class="table table-striped table-bordered sys_table">
            ...
            <tbody id="adv" >
                ...
                <td></td>
                <td>
                    <asp:Button ID="EBtnSubmit" runat="server" class="btn btn-outline-info" Text="保存信息" OnClientClick="javascript:return CheckForm();" OnClick="EBtnSubmit_Click" />
