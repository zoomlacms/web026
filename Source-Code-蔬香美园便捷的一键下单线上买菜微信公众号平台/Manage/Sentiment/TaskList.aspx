...
<div class="table-responsive"> 
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False"  
            ...
            <Columns>
                <asp:TemplateField HeaderText="" ItemStyle-CssClass="" ItemStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                ...
                <ItemTemplate>
                <a href="AddTask.aspx?ID=<%#Eval("ID") %>" ><i class="fa fa-pencil" title="修改"></i></a>
                ...
                <a href="GetReport.aspx?Skey=<%#HttpUtility.UrlEncode(Eval("Condition","")) %>" class="report_a"><i class="fa fa-eye" title="查看"></i>查看报告</a>                
                </ItemTemplate>
                </asp:TemplateField>            
            </Columns>
