    ...
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="false" PageSize="10" OnRowCommand="EGV_RowCommand"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="<%#Eval("Link") %>" title="点击浏览" target="_blank" ><i class="fa fa-globe"></i></a>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="catch" ToolTip="抓取文章" ><i class="fa fa-plus"></i>抓取文章</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
