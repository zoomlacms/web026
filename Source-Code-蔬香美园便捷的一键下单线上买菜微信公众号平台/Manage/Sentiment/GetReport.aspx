<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetReport.aspx.cs" Inherits="ZoomLaCMS.Manage.Sentiment.GetReport" MasterPageFile="~/Common/Master/Empty2.master"%>
<%@ Import Namespace="ZoomLaCMS.Manage.Sentiment" %>
<asp:Content runat="server" ContentPlaceHolderID="head"></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
<div class="c_chinabox">
