<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WSApi.aspx.cs" Inherits="ZoomLaCMS.Manage.APP.WSApi" MasterPageFile="~/Manage/I/Index.master" %>
...
<%=Call.SetBread(new Bread[] {
	...
	new Bread() {url="", text="跨域网站接入<a href='AddUcenter.aspx'>[添加授权网站]</a>",addon= "" }}
	)
%>
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" 
        ...
        CssClass="table table-striped table-bordered table-hover list_choice" EnableTheming="False" EnableModelValidation="True" EmptyDataText="没有内容">
        <Columns>
    ...
    <div>
        <div class="card sys_prebox">
            <div class="card-header bg-info text-white"><span class="fa fa-flag"></span><span class="margin_l5">接口说明</span></div>
            <div class="card-body">
                <div>
				<strong>使用说明：</strong>跨站接入2.0是针对Zoomla！逐浪CMS2产品线，并基于标准的WebServices标准制定的接口平台，网站通过此认证后,可以分别就用户管理,问答管理,内容管理,或对指定的表进行接口操作,其使用如下：
				</div>
                <div>
                    1,添加授权网站,自动生成Key<br />
