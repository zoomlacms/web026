...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="tab-content">
        ...
        <tr>
            <th>操作</th>
            <td>
                <asp:Button runat="server" ID="Save_Btn" CssClass="btn btn-outline-info" OnClick="Save_Btn_Click" Text="保存" />
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        var paramtlp = "<div class='d-flex flex-row mt-2'><input name='param' placeholder='参数名' class='form-control w12rem_lg' /> <select name='paramtype' class='form-control w12rem_lg'><option value='string'>string</option><option value='int'>int</option><option value='like'>like</option></select>"
                     + " <input name='defvalue' placeholder='默认值' class='form-control w12rem_lg' /> <button type='button' onclick='removeParams(this)' class='btn btn-default'><span class='fa fa-minus'></span></button></div>";
