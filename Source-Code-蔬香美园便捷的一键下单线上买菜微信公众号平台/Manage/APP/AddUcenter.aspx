     ...
     <table class="table table-striped table-bordered table-hover sys_table">
      <tr class="spacingtitle">
        <td align="center" colspan="2" ><asp:Label ID="lblText" runat="server">添加授权网站</asp:Label></td>
         ...
         <tr><th class="w12rem_lg"><strong>授权名称</strong></th><td><asp:TextBox runat="server" ID="Alias_T" CssClass="form-control max20rem required" /></td></tr>
      <tr>
        ...
        <td><asp:TextBox ID="TxtWebSite" class="form-control max20rem isurl" runat="server" placeholder="www.z01.com" />
         ...
         <tr><th><strong>用户管理</strong></th>
             ...
             <tr><td><strong>启用：</strong></td><td><input type="checkbox" runat="server" id="Status_Chk" checked="checked" class="switchChk" /></td></tr>
         <tr>
		 <td></td>
		 <td colspan="2" >
             <asp:Button ID="BtnCommit" runat="server" Text="提交" class="btn btn-outline-info" OnClick="Button1_Click" />
