    ...
    <div class="row">
        <ol id="BreadNav" class="breadcrumb navbar-fixed-top w-100">
            ...
            <li class="breadcrumb-item"><a href="/admin/Mobile/Push/APIList.aspx">API列表</a> [<a href="AddAPI.aspx">添加API</a>]</li>
             <a href="https://www.jpush.cn" target="_blank" class="pull-right ml-auto mr-2"><i class="fa fa-lightbulb-o"></i> 注册账号</a>
        </ol>
    </div>
</div> 
 <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a  href="AddAPI.aspx?id=<%#Eval("ID") %>"><i class="fa fa-pencil" title="修改"></i></a>
