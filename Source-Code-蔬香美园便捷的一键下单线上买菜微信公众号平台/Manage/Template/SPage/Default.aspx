            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="SPage_list">
                    ...
                    <div class="SPage_list_b">
                        ...
                        <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="copy" OnClientClick="return confirm('确定要复制吗');"><i class="fa fa-copy"></i> 复制</asp:LinkButton>
