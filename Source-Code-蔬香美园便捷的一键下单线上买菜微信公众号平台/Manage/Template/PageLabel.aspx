    ...
    <table class="table table-striped table-bordered sys_table">
                    ...
                    <tr>
                        <td>
                            <div id="labellist" class="btn-group d-flex flex-wrap">
                                <div code="{totalrecord/}" onclick="cit(this)" class="btn btn-outline-info">
                                    总记录</div>
                                <div code="{totalpage/}" onclick="cit(this)" class="btn btn-outline-info">
                                    总页数</div>
                                <div code="{pagesize/}" onclick="cit(this)" class="btn btn-outline-info">
                                    每页显示数</div>
                                <div code="{currenturl/}" onclick="cit(this)" class="btn btn-outline-info">
                                    当前页路径</div>
                                <div code="{firsturl/}" onclick="cit(this)" class="btn btn-outline-info">
                                    首页地址</div>
                                <div code="{prvurl/}" onclick="cit(this)" class="btn btn-outline-info">
                                    上一页地址</div>
                                <div code="{nexturl/}" onclick="cit(this)" class="btn btn-outline-info">
                                    下一页地址</div>
                                <div code="{endurl/}" onclick="cit(this)" class="btn btn-outline-info">
                                    尾页地址</div>                                   
                                <div code="{currentpage/}" onclick="cit(this)" class="btn btn-outline-info">
                                    当前页码</div>
                                <div code="{prvpage/}" onclick="cit(this)" class="btn btn-outline-info">
                                    上一页页码</div>
                                <div code="{nextpage/}" onclick="cit(this)" class="btn btn-outline-info">
                                    下一页页码</div>
                                <div code="{endpage/}" onclick="cit(this)" class="btn btn-outline-info">
                                    尾页页码</div>
                                <div code="{loop range=\'显示半径\'}循环代码$$$当前代码{/loop}" onclick="cit(this)" class="btn btn-outline-info">
                                    分页循环</div>
                                <div code="{pageid/}" onclick="cit(this)" class="btn btn-outline-info">
                                    循环内页码</div>                                
                                <div code="{pageurl/}" onclick="cit(this)" class="btn btn-outline-info">
                                    循环内路径</div>
                            </div>
                        </td>
                    </tr>
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;
                &nbsp;<asp:Button ID="BtnSave" class="btn btn-outline-info"  OnClick="BtnSave_Click"
