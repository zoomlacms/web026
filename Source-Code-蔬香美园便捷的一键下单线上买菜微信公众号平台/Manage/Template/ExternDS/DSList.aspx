...
<ZL:ExGridView ID="EGV" runat="server" AllowPaging="True" AutoGenerateColumns="false" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="操作">
            <ItemTemplate>
                <a href="DSAdd.aspx?ID=<%#Eval("ID") %>"><i class="fa fa-pencil" title="修改"></i></a>
                <asp:LinkButton runat="server" CommandName="del2" CommandArgument='<%# Eval("ID") %>' OnClientClick="return confirm('确定删除该数据源?');"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</ZL:ExGridView>
