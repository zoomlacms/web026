...
var HtmlUtil = {
    ...
    removeUrlRoot: function (text) {
        ...
        return text;
        //test("http://WWW.BAIDU.COM/UploadFiles/ttt.gif");
        //test("http://x044.sss.com/UploadFiles/ttt.gif");
        //test("http://x044.2013.hx008.com/UploadFiles/nopic.gif");
        //test("http://win10:86/Uploadfiles/ttt.gif");
    }
};
//var patrn = /^([0-9]|[\+]|[\-]){6,20}$/;
